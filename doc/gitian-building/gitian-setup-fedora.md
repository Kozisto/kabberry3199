...
The build script we'll be using is contained in the Kabberry github repository ([contrib/gitian-build.py](https://github.com/kabberry-project/kabberry/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Kabberry repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Kabberry-Project/Kabberry/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, kabberry-detached-sigs, and kabberry GitHub repos.
