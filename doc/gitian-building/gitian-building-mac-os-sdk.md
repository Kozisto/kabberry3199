...
The script [extract-osx-sdk.sh](https://github.com/kabberry-project/kabberry/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
kabberry/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/kabberry-project/kabberry/blob/master/doc/README_osx.md) for troubleshooting tips.