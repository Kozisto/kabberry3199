...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR KKC</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                KabberryGUI* window = static_cast<KabberryGUI*>(parentWidget());
...
{
    KabberryGUI* gui = static_cast<KabberryGUI*>(parentWidget());
...
{
    hide();
    static_cast<KabberryGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Kabberry will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your KKCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
