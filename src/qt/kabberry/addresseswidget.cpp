...
#include "qt/kabberry/forms/ui_addresseswidget.h"
#include "qt/kabberry/addresslabelrow.h"
#include "qt/kabberry/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(KabberryGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter Kabberry address"));
