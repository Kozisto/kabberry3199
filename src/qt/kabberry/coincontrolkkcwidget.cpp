...
#include "qt/kabberry/coincontrolkkcwidget.h"
#include "qt/kabberry/forms/ui_coincontrolkkcwidget.h"

CoinControlKKCWidget::CoinControlKKCWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlKKCWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select KKC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("KKC");
    ...
    ui->labelValueAfter->setText("0.00 KKC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 KKC");
    ui->labelValueFee->setText("0.00 KKC");
...
CoinControlKKCWidget::~CoinControlKKCWidget()
{
    delete ui;
}
