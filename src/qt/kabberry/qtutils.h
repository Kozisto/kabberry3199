...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, KabberryGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, KabberryGUI *gui, double posX = 3);
