...
#include "qt/kabberry/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/kabberry/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(KabberryGUI* _window, QWidget *parent) :
