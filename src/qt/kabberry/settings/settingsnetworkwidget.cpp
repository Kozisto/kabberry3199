...
#include "qt/kabberry/settings/settingsnetworkwidget.h"
#include "qt/kabberry/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/kabberry/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KabberryGUI* _window, QWidget *parent) :
