...
#include "qt/kabberry/forms/ui_masternodeswidget.h"
#include "qt/kabberry/qtutils.h"
#include "qt/kabberry/mnrow.h"
#include "qt/kabberry/mninfodialog.h"

#include "qt/kabberry/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(KabberryGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 10000)){
            inform(tr("Not enough balance to create a masternode, 10,000 KKC required."));
            return;
        }
        showHideOp(true);
