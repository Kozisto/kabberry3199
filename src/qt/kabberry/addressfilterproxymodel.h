...
#ifndef Kabberry_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Kabberry_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Kabberry_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
