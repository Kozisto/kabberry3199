...
#ifndef Kabberry_sKKCWALLET_H
#define Kabberry_sKKCWALLET_H
...
public:
    CsKKCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicsKKC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTosKKC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
