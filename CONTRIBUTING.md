Contributing to kabberry Core
============================

The kabberry Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/kabberry-project/kabberry/blob/master/doc/translation_process.md)
...
The following applies to code changes to the kabberry Core project, and is not to be
confused with overall kabberry Network Protocol consensus changes.

Whether a pull request is merged into kabberry Core rests with the project merge
...
Where a patchset proposes to change the kabberry consensus, it must have been
...
The project leader is the release manager for each kabberry Core release.
