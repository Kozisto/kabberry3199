...
class RawTransactionsTest(KabberryTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kabberry address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kabberry address" in e.error['message'])
