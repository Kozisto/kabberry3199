...
"""Verify that starting kabberry with -h works as expected."""
import subprocess

from test_framework.test_framework import KabberryTestFramework
from test_framework.util import assert_equal

class HelpTest(KabberryTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kabberry with -h for help text")
        ...
        self.log.info("Start kabberry with -version for version information")
